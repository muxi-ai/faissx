...
from app.models.schemas import VectorBatch, SearchRequest, SearchResponse, SearchResult
...
@router.delete("/v1/index/{index_id}/vectors/{vector_id}", status_code=status.HTTP_204_NO_CONTENT)
